    ...
    <section className="py-20 md:py-28 px-6">
      <div className="container max-w-5xl mx-auto">
        <div className="text-center mb-14">
          <p className="text-sm font-medium text-primary mb-3">Sales Channels</p>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          {channels.map((ch) => (
            <div
              key={ch.title}
              className="flex items-start gap-4 p-5 rounded-xl border border-border bg-card hover:shadow-card-hover transition-all duration-200 group"
            >
