...
import { Package, TrendingUp, Wallet, ShoppingCart, ArrowUpRight, ArrowDownRight } from "lucide-react";
...
const stats = [
  ...
  { label: "Pending Orders", value: "18", change: "-3", up: false, icon: ShoppingCart },
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">Here's an overview of your production portfolio.</p>
        </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border/50">
                  <th className="text-left text-xs font-medium text-muted-foreground px-5 py-3">Batch Name</th>
